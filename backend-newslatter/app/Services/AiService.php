...
class AiService
{
    public function process ($title /*, $description*/ , $content) {
        ...
        3. Escribe el contenido completo (formato HTML simple, usa <p>).
        4. Asigna un puntaje de relevancia del 0.1 a 5.0, según el impacto informativo que pueda tener la noticia.
